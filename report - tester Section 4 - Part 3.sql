...
CREATE TABLE #B30AccDocSales (Id INT IDENTITY, ItemCode VARCHAR(64), Quantity NUMERIC(18), Amount NUMERIC(18,2));
...
CREATE TABLE #temp (No INT, Code VARCHAR(32), DocDate DATE, DocNo VARCHAR(32), Description NVARCHAR(MAX)
					, Quantity NUMERIC(18), Amount NUMERIC(18,2), Discount NUMERIC(18,2));
	...
	DECLARE @_Discount_10tr Numeric(18,2), @_Discount_20tr Numeric(18,2);
...
DECLARE @_SUM_Quantity NUMERIC(18,2), @_SUM_Amount NUMERIC(18,2), @_SUM_Discount NUMERIC(18,2);
